...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Approval Group Summary") ?></h2></div>
        <?php echo message();    ?>
                    ...
                    <tr>
                        ...
                        <td scope="col">
                            <?php
                                ...
                                }else{$feild="t.td_inst_name_".$culture;}
                            ?>
    <?php echo $sorter->sortLink($feild, __('Approval Group Name'), '@wfgrpapp', ESC_RAW);  ?>
                ...
                <tbody>
                    ...
                    foreach ($AppGroupList as $GroupList) {
                    ...
                    ?>
                        <tr class="<?php echo $cssClass ?>">
                            <td>
                                <input type='checkbox' class='checkbox innercheckbox' name='chkLocID[]' id="chkLoc" value='<?php echo $GroupList->wfappgrp_code ?>' />
                            </td>

                            <td class="">
                                <a href="<?php echo url_for('workflow/SaveAppGroup?id=' . $GroupList->wfappgrp_code) ?>">
                                <?php
                               
                                    echo $GroupList->wfappgrp_description;
